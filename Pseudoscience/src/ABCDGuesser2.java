...
public final class ABCDGuesser2 {
    ...
    private static double deJager(double w, double x, double y, double z,
        ...
        // each one of these for loops iterate through the loop to see if the
        // the number at the given point will satisfy the estimate
        for (a = 0; a < powers.length; a++) {
            for (b = 0; b < powers.length; b++) {
                for (c = 0; c < powers.length; c++) {
                    for (d = 0; d < powers.length; d++) {
        ...
        out.print(error, decimalPlaces, scientific);
        out.println(" percent");
        out.close();
